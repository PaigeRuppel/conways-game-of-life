...
public class BoardTest {
	...
	@Before
	public void setup() {
		CellState[][] blinker = { { DEAD, DEAD, DEAD, DEAD, DEAD }, { DEAD, DEAD, ALIVE, DEAD, DEAD },
				{ DEAD, DEAD, ALIVE, DEAD, DEAD }, { DEAD, DEAD, ALIVE, DEAD, DEAD },
				{ DEAD, DEAD, DEAD, DEAD, DEAD } };

		// CellState[][] toad = {{DEAD, DEAD, DEAD, DEAD, DEAD, DEAD},
	...
	@Test
	public void tickWithTwoLivingCellsBothCellsDie() {
		CellState[][] ruleOne = { { ALIVE, DEAD }, { ALIVE, DEAD } };
		underTest = new Board(ruleOne);
		underTest.tick();
		assertThat(underTest.getGridCoords(0, 0), is(DEAD));
		assertThat(underTest.getGridCoords(1, 0), is(DEAD));
	}

	@Test
	public void tickWithThreeLivingCellsOnOneRowMiddleStaysAlive() {
		CellState[][] ruleOne = { { ALIVE, ALIVE, ALIVE } };
		underTest = new Board(ruleOne);
		underTest.tick();
		assertThat(underTest.getGridCoords(0, 0), is(DEAD));
		assertThat(underTest.getGridCoords(0, 1), is(ALIVE));
		assertThat(underTest.getGridCoords(0, 2), is(DEAD));
	}
}
